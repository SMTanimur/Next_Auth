 ...
 */
 ...
 export const activationTemplate = (url,txt,to) => {
  return `
  ...
  <div style='max-width: 600px; width:100%; padding-bottom: 35px; margin: auto; background: #fff; text-align: center;'>
    ...
    <p style='margin: 25px 0; font-size: 20px; font-weight: 300;'>Hi <strong>${to}</strong>,</p>
    <p style='margin: 25px 0; font-size: 20px; font-weight: 300;'> <strong>${txt}</strong>,</p>
    <p style='color:#0072ff ; padding:0 20px; max-width: 450px; margin: auto; margin-bottom: 25px; font-weight: 300'>
